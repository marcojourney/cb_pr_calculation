...
describe("#Salary Calculation", () => {
    ...
    describe("#Get Tax On Salary", () => {
        it("Give basic salary:0, should return 0%", () => {
            assert.equal((0, tax_1.getTaxOnSalary)(0, salaryTaxRates), 0);
        });
        it("Give basic salary:100000, should return 0%", () => {
            assert.equal((0, tax_1.getTaxOnSalary)(100000, salaryTaxRates), 0);
        });
        it("Give basic salary:500000, should return 0%", () => {
            assert.equal((0, tax_1.getTaxOnSalary)(500000, salaryTaxRates), 0);
        });
        it("Give basic salary:1500000, should return 0%", () => {
            assert.equal((0, tax_1.getTaxOnSalary)(1500000, salaryTaxRates), 0);
        });
        it("Give basic salary:2000000, should return 5%", () => {
            assert.equal((0, tax_1.getTaxOnSalary)(2000000, salaryTaxRates), 25000);
        });
        it("Give basic salary:3000000, should return 10%", () => {
            assert.equal((0, tax_1.getTaxOnSalary)(3000000, salaryTaxRates), 125000);
        });
        it("Give basic salary:8500000, should return 675000", () => {
            assert.equal((0, tax_1.getTaxOnSalary)(8500000, salaryTaxRates), 675000);
        });
        it("Give basic salary:10000000, should return 10%", () => {
            assert.equal((0, tax_1.getTaxOnSalary)(10000000, salaryTaxRates), 900000);
        });
        it("Give basic salary:12500000, should return 15%", () => {
            assert.equal((0, tax_1.getTaxOnSalary)(12500000, salaryTaxRates), 1275000);
        });
    });
    describe("#Get Salary Tax Rate", () => {
        it("Give basic salary:1500000, should return 0%", () => {
            assert.equal((0, tax_1.getTaxRateBySalary)(1500000, salaryTaxRates), 0);
        });
        it("Give basic salary:2000000, should return 5%", () => {
            assert.equal((0, tax_1.getTaxRateBySalary)(2000000, salaryTaxRates), 5);
        });
        it("Give basic salary:3000000, should return 10%", () => {
            assert.equal((0, tax_1.getTaxRateBySalary)(3000000, salaryTaxRates), 10);
        });
        it("Give basic salary:12500000, should return 15%", () => {
            assert.equal((0, tax_1.getTaxRateBySalary)(12500000, salaryTaxRates), 1275000);
        });
    });
});
